...
| 仓库 | 说明 |
|------|------|
| [docker_template](https://github.com/ycpss91255-docker/docker_template) | 模块化 Bash 工具包 — 自动检测系统参数并生成 `.env` |
...
<details>
<summary><strong>如何选择？</strong></summary>
...
<details>
<summary><strong>快速开始（任何环境 repo）</strong></summary>
...
<details>
<summary><strong>按主题筛选</strong></summary>
